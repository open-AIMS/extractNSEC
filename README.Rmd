...
`extractNSEC` package extracts the NSEC estimate from supported fitted frequentest (drc) and Bayesian (bayesnec) model objects (see Fox (2010)<https://setac.onlinelibrary.wiley.com/doi/full/10.1002/etc.5610?af=R>).
